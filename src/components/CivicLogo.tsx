...
export const CivicLogo: React.FC<CivicLogoProps> = ({
  ...
  useEffect(() => {
    ...
    window.addEventListener('civic-logo-updated', handleUpdate);
    window.addEventListener('storage', handleUpdate);
    return () => {
      window.removeEventListener('civic-logo-updated', handleUpdate);
  ...
  const currentImgSrc = customLogo || '/civic_innovators_logo.jpg';
